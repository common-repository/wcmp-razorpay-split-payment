...
function woocommerce_razorpay_init()
{
    ...
    class WC_Razorpay extends WC_Payment_Gateway
    {
        ...
        public function init_form_fields()
        {
            ...
            $defaultFormFields = array(
                ...
                'enable_webhook' => array(
                    ...
                    'type' => 'checkbox',
                    'description' =>  "<span>$webhookUrl</span><br/><br/>",
                    ...
                    foreach( $suborders_list as $suborder ) {
                        ...
                        if ( $razorpay_enabled && $vendor_razorpay_account_id ) {
                            ...
                            if ($vendor_commission > 0) {
                                $receivers[] = array(
                                    'account'       => $vendor_razorpay_account_id,
        ...
        private function enqueueCheckoutScripts($data)
        {
            ...
            {
                wp_register_script('razorpay_wc_script', plugin_dir_url(__FILE__)  . '../assets/frontend/js/script.js',
                null, null);
            }
            else
            {
